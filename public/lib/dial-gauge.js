...
<div class="dial-gauge">
    <svg width="100%" height="100%">
        ...
        <text id="gauge-subtitle" x="50%" y="65%"></text>
    </svg>
</div>
`;
...
styleSheet.replaceSync(`
    ...
    .dial-gauge {
        ...
        height: var(--dg-height, 243px);
        margin: var(--dg-margin, 0);
        text-align: center;
        width: var(--dg-width, 243px);
        z-index: var(--dg-z-index, 0);
    }

    #gauge-title {
        display: none;
        fill: var(--dg-title-color, #194A82);
    ...
    svg > #gauge-background-arc {
        stroke: var(--dg-arc-background-color, #779BDF);
        stroke-width: var(--dg-arc-width, 20);
    }

    svg > #gauge-arc {
        stroke: var(--dg-arc-color, #194A82);
        stroke-width: var(--dg-arc-width, 20);
    }
    ...
    #gauge-numeric {
        ...
        fill: var(--dg-numeric-color, #194A82);
    ...
    #gauge-subtitle {
        display: none;
        fill: var(--dg-subtitle-color, , #194A82);
